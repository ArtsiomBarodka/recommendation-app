...
public class CurrencyDBServiceImplTest {
    @Mock
    private CurrencyEventRepository currencyEventRepository;
    ...
    void saveAllTest() {
        ...
        when(currencyEventRepository.save(any())).thenReturn(resultCurrencyEventEntity);
        ...
        assertEquals(resultCurrencyEntity.getCryptoSymbol().getId(), resultItem.getSymbol().getId());
        assertEquals(resultCurrencyEntity.getCryptoSymbol().getName(), resultItem.getSymbol().getName());
    }
